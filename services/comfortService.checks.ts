...
const HOT_UV_READING: DeviceReading = {
  ...COMFORTABLE_READING,
  id: 'reading-test-hot',
  temperature: 31,
  uvIndex: 8,
...
export function runComfortSelfChecks(): void {
  ...
  const hotUv = calculateComfortIndex(HOT_UV_READING, LOW_SENSITIVITY_PROFILE);
  assert(hotUv.score < comfortable.score, 'hot + UV should lower score');
